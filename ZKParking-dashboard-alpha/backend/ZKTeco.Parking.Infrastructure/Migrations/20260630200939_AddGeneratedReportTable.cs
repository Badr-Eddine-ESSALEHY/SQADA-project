...
{
    /// <inheritdoc />
    public partial class AddGeneratedReportTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    parking_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    generated_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_generated_report", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_generated_report_generated_at",
